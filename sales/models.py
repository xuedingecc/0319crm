...
class SaleChance(models.Model):
    ...
    # 联系人
    linkMan = models.CharField(max_length=100, db_column='link_man')
    # 联系电话
    linkPhone = models.CharField(max_length=100, db_column='link_phone')
    # 描述
    description = models.CharField(max_length=1000, db_column='description')
    # 创建人
    createMan = models.CharField(max_length=100, db_column='create_man')
    # 分配给谁
    assignMan = models.CharField(max_length=100, db_column='assign_man')
    # 分配时间
    assignTime = models.DateTimeField(db_column='assign_time', null=True)
    # 状态 1-如果有分配就是已分配状态，0-未分配
    state = models.IntegerField(max_length=20, db_column='state')
    # 开发状态 0-未开发 1-已开发 2- 开发完成 3-开发失败
    devResult = models.CharField(max_length=20, db_column='dev_result', default=0)
...
class CusDevPlan(models.Model):
    # 关联营销机会
    saleChance = models.ForeignKey(SaleChance, db_constraint=False, db_column='sale_chance_id',
                                   on_delete=models.DO_NOTHING)
    # 计划内容
    planItem = models.CharField(max_length=100, db_column='plan_item')
    # 计划时间
    ...
    isValid = models.IntegerField(db_column='is_valid', default=1)
    createDate = models.DateTimeField(default=datetime.now(), db_column='create_date')
    updateDate = models.DateTimeField(db_column='update_date')
